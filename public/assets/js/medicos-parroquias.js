const select = document.getElementById("id_parroquia");
...
function filtrado_parroquias() {
    let id_parroquia = select.value;
    console.log(id_parroquia);
    fetch(`/SIMA/medicos-ver-reporte-parroquias/${id_parroquia}`, {
        method: "GET",
        headers: {
...
function descargarPDF() {
    ...
    let id_parroquia = select.value;
    url = "/SIMA/medicos-generar-reporte-parroquias/" + id_parroquia;
