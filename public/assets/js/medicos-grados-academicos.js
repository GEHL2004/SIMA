const select = document.getElementById("grados");
...
function filtrado_grados() {
    let id_grado = select.value;
    console.log(id_grado);
    fetch(`/SIMA/medicos-ver-reporte-grados-academicos/${id_grado}`, {
        method: "GET",
        headers: {
...
function descargarPDF() {
    ...
    let id_grado = select.value;
    url = "/SIMA/medicos-generar-reporte-grados-academicos/" + id_grado;
