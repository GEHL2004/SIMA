...
function filtrado_municipios() {
    let id_municipio = select.value;
    console.log(id_municipio);
    fetch(`/SIMA/medicos-ver-reporte-municipios/${id_municipio}`, {
        method: "GET",
        headers: {
...
function descargarPDF() {
    ...
    let id_municipio = select.value;
    url = "/SIMA/medicos-generar-reporte-municipios/" + id_municipio;
