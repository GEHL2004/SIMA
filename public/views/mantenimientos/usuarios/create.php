...
<div class="conatiner-fluid content-inner py-0">
    <div class="row">
        <div class="col-md-12 col-lg-12">
            ...
            <div class="row justify-content-center ">
                ...
                <div class="col-lg-1 mb-3 mb-lg-0">
                    <a href="/SIMA/usuarios">
                        <button type="button" class="btn btn-primary btn-lock" id="botonregresar">
                            <i class="fa-solid fa-arrow-left"></i>
                        </button>
                    </a>
                </div>
                <div class="col-lg-9 mb-4">
                    <h1 class="text-center text-primary"><i class="fa-solid fa-user-plus me-2"></i> Registro de Nuevo Usuario <i class="fa-solid fa-user-plus ms-2"></i></h1>
                </div>
                <div class="col-lg-1"></div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <form action="/SIMA/usuarios-store" method="POST" enctype="multipart/form-data" id="form" novalidate>
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-pill" name="cedula" id="cedula" placeholder="V-12345678" required>
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-pill" name="nombres" id="nombres" required>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text rounded-start-pill"><i class="fa-solid fa-user"></i></span>
                                    <input type="text" class="form-control rounded-end-pill" name="apellidos" id="apellidos" required>
                                    <div class="invalid-feedback">
                                        Este campo es obligatorio.
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-pill" name="nombre_user" id="nombre_user" required>
                                    <div class="invalid-feedback">
                                        Este campo es obligatorio.
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control rounded-end-pill" name="password_user" id="password_user" required>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select rounded-end-pill" name="nivel" id="nivel" required>
                                        ...
                                        <option value="1">Super Administrador(a)</option>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-pill" name="pregunta_secreta" id="pregunta_secreta" required>
                                    <div class="invalid-feedback">
                                        Este campo es obligatorio.
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-pill" name="respuesta_secreta" id="respuesta_secreta" required>
                                    <div class="invalid-feedback">
                                        Este campo es obligatorio.
                                    </div>
                                </div>
