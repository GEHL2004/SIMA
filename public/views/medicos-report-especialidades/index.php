        ...
        <div class="col-md-12 col-lg-12">
            ...
            <div class="row">
                <div class="text-center mb-3 mt-2">
                    <h1 class="text-primary">Consulta de Medicos por Especialidad</h1>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center p-4 mb-4 bg-light-subtle">
                <div>
                    <p style="font-size: 0.95rem; color: black; margin: 5px 0 0 0;">
                        Especialidad:
                        <select class="form-select" id="select-especialidades" onchange="filtrado_especialidades();">
...
<script src="<?php echo $_ENV['APP_URL'] . $_ENV['BASE_PATH'] . $_ENV['APP_PUBLIC']; ?>/assets/js/medicos-especialidades.js"></script>