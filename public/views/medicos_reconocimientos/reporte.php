        ...
        <div class="col-md-12 col-lg-12">
            ...
            <div class="row">
                <div class="text-center mb-3 mt-2">
                    <h2 class="text-primary mb-1">Listado de medicos con reconocimiento <?php echo $request['estado']; ?></h2>
                    <h4 class="text-black-50">- Listado de médicos de <?php echo $request['intervalo']; ?> años -</h4>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center p-4 mb-4 bg-light-subtle">
                <div>
                    <a href="/SIMA/medicos-reconocimientos">
                    ...
                    <table id="tabla" class="table table-bordered table-sm mb-0" style="width:100%">
                        <thead class="align-middle">
                            <tr>
                                ...
                                <th class="text-center bg-body-tertiary">Nombre del médico</th>
                                <th class="text-center bg-body-tertiary">Teléfono</th>
                                <th class="text-center bg-body-tertiary">Correo</th>
                                <th class="text-center bg-body-tertiary">Años de graduado</th>
                            </tr>
                        </thead>
                        <tbody class="align-middle">
                            <?php foreach ($data as $i => $valor) { ?>
                                <tr>
                                    <td class="text-center"><?php echo $valor['contador']; ?></td>
                                    <td class="text-center"><?php echo $valor['nombres_apellidos']; ?></td>
                                    <td class="text-center"><?php echo $valor['telefono']; ?></td>
                                    <td class="text-center"><?php echo $valor['correo']; ?></td>
                                    <td class="text-center"><?php echo $valor['años_transcurridos_graduado']; ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
...
<script>
    const data = JSON.parse(<?php echo json_encode(json_encode($data)); ?>);
    var tipo_reconocimiento = <?php echo $request['tipo_reconocimiento']; ?>;
    var intervalo = <?php echo $request['intervalo']; ?>;
    var cantidad = <?php echo $request['cantidad']; ?>;
    var estado = '<?php echo $request['estado']; ?>';
</script>

<script src="<?php echo $_ENV['APP_URL'] . $_ENV['BASE_PATH'] . $_ENV['APP_PUBLIC']; ?>/assets/js/medicos-reconocimientos-reporte.js"></script>