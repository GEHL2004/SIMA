...
<div class="text-center mb-3">
    <h1 style="font-size: 1.8rem; font-weight: 600; color: black; margin: 0;">Médicos por Especialidad</h1>
    <p style="font-size: 1.1rem; font-weight: 300; color: black; margin: 5px 0 0 0;">Especialidad: <strong><?php echo $datos[0]['nombre_especialidad']; ?></strong></p>
