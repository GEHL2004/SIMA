...
<div class="text-center mb-3">
    <h1 style="font-size: 1.8rem; font-weight: 600; color: black; margin: 0;">Médicos por Parroquias</h1>
    <p style="font-size: 1.1rem; font-weight: 300; color: black; margin: 5px 0 0 0;">Municipio: <strong><?php echo $datos[0]['nombre_municipio']; ?></strong></p>
    <p style="font-size: 1.1rem; font-weight: 300; color: black; margin: 5px 0 0 0;">Parroquia: <strong><?php echo $datos[0]['nombre_parroquia']; ?></strong></p>
...
<table id="tabla" class="table table-bordered mb-0">
    ...
    <tbody>
        ...
        <?php else: ?>
            <tr>
                <td class="text-center align-middle" style="padding: 12px 15px;" colspan="7">No se poseen medicos de perteneciente a esta parroquia</td>
            </tr>
        <?php endif; ?>
    </tbody>
</table>
