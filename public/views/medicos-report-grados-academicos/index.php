        ...
        <div class="col-md-12 col-lg-12">
            ...
            <div class="row">
                <div class="text-center mb-3 mt-2">
                    <h1 class="text-primary">Consulta de Medicos por Grados Academicos</h1>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center p-4 mb-4 bg-light-subtle">
                <div>
                    <p style="font-size: 0.95rem; color: black; margin: 5px 0 0 0;">
                        Grado Academico:
                        <select class="form-select" id="grados" onchange="filtrado_grados();">
                            <option value="" selected disabled>- Seleccione -</option>
                            <?php foreach ($grados as $i => $grado) { ?>
                                <option value="<?= $grado['id_grado_academico']; ?>"><?= $grado['nombre_grado']; ?></option>
                            <?php } ?>
                        </select>
                    </p>
                </div>
...
<script src="<?php echo $_ENV['APP_URL'] . $_ENV['BASE_PATH'] . $_ENV['APP_PUBLIC']; ?>/assets/js/medicos-grados-academicos.js"></script>