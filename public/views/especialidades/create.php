        ...
        <div class="col-md-12 col-lg-12">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-9 mb-4">
                    <h1 class="text-center text-primary">Registro de Nueva Especialidad</h1>
                </div>
                <div class="col-lg-1"></div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <form action="/SIMA/especialidades-store" method="POST" id="form" novalidate>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-lg-6">
                                <label for="respuesta_secreta" class="form-label">Categoría: <span class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-12 col-lg-6">
                                <label for="respuesta_secreta" class="form-label">Tipo de Práctica: <span class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="col-12 col-lg-6">
                                <label for="respuesta_secreta" class="form-label">Sistema Corporal: <span class="text-danger">*</span></label>
                                <div class="input-group">
